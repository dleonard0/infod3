...
static const char help_text[] =
	...
	" If a client's string doesn't start with \" then it's assumed\r\n"
	" literal and continues without escape processing until next SPC,\r\n"
	" or EOL. If it's the last arg then it's to EOL ignoring trailing\r\n"
	" spaces. The server will always quote its strings.\r\n"
	"\r\n"
	"Patterns:\r\n"
